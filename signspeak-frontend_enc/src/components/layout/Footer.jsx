    ...
    <footer className="bg-slate-950 border-t border-slate-800">
      <div className="container-page py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              AI-powered sign language learning platform. Learn, practice, and get assessed.
            </p>
          </div>
          <div>
            <h4 className="text-sm font-semibold text-white mb-4">Platform</h4>
            <ul className="space-y-2.5">
              <li><Link to="/courses" className="text-sm text-slate-500 hover:text-primary transition-colors">Courses</Link></li>
              <li><Link to="/practice" className="text-sm text-slate-500 hover:text-primary transition-colors">Practice</Link></li>
              <li><Link to="/assessments" className="text-sm text-slate-500 hover:text-primary transition-colors">Assessments</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-10 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600">&copy; 2026 SignSpeak. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <a href="#" className="text-slate-500 hover:text-primary transition-colors"><Github size={18} /></a>
            <a href="#" className="text-slate-500 hover:text-primary transition-colors"><Twitter size={18} /></a>
